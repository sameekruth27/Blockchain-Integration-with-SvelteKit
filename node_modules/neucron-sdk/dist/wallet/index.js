...
class Wallet {
  ...
  async createWallet(options) {
    try {
      ...
      const queryString = `walletName=${encodeURIComponent(options.walletName)}` + (options.mnemonic ? `&mnemonic=${encodeURIComponent(options.mnemonic)}` : '') + (options.appId ? `&appID=${encodeURIComponent(options.appId)}` : '');
